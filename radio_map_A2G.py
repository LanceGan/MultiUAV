...
if __name__ == '__main__':
    ...
    plt.savefig('results/figs/OutageMapActualSINR_A2G.png', dpi=300, bbox_inches='tight')
    plt.show()
    ...
    plt.xlabel('x (meter)', fontsize=14)
    plt.ylabel('y (meter)', fontsize=14)
    plt.savefig('results/figs/OutageMapActual_A2G.png', dpi=300, bbox_inches='tight')
    plt.show()
    
    
    np.savez('results/datas/Radio_datas_A2G', OutageMapActual, OutageMapActualSINR ,X_vec, Y_vec)