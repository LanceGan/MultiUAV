...
if __name__ == '__main__':
    ...
    # 加载聚类结果
    if mode_add == 'origin':
        cluster_result = 'results/datas/cluster/Users_%d_Clustered'% user_num+'UAV_'+str(UAV_NUM)+'.txt'
        cluster_label = load_cluster(cluster_result,user_num)
    elif mode_add == 'comm':
        cluster_result = 'results/datas/cluster/Users_%d_Clustered_comm'% user_num+'UAV_'+str(UAV_NUM)+'.txt'
        cluster_label = load_cluster(cluster_result,user_num)
    elif mode_add == 'None':
        print("✗ 未选择聚类结果文件")
    ...
    if mode == 'cluster':
        save_path = 'results/figs/cluster/'+'UAV_'+str(UAV_NUM)+'_'+str(mode_add)+'_'+str(Radio_Map)+'.png' 
    elif mode == 'user':
        save_path = 'results/figs/users/'+'Users_'+str(user_num)+'_'+str(Radio_Map)+'.png'
