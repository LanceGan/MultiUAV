...
if __name__ == '__main__':
    ...
    aco = ACO(num_city=data.shape[0], data=data.copy(), start_node=0, end_node=data.shape[0]-1)
    ...
    plt.title('ACO Path', fontsize=16)
    plt.savefig('results/figs/ACO_path.png', dpi=300, bbox_inches='tight')
    plt.show()
